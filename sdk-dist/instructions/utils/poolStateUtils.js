...
export class PoolStateUtils {
     ...
     */
    static isDecayFeeEnabled(poolInfo) {
     ...
     */
    static isDecayFeeOnSellMint0(poolInfo) {
     ...
     */
    static isDecayFeeOnSellMint1(poolInfo) {
     ...
     */
    static getDecayFeeRate(poolInfo, currentTimestamp) {
        ...
        const intervalCount = Math.floor((currentTimestamp - poolInfo.openTime.toNumber()) / poolInfo.decayFeeDecreaseInterval);
     ...
     */
    static getDecayFeeInfo(poolInfo, currentTimestamp) {
     ...
     */
    static async getPoolStateWithDecayFee(connection, poolId, currentTimestamp) {
     ...
     */
    static getDecayFeeForDirection(poolInfo, zeroForOne, currentTimestamp) {
        const timestamp = currentTimestamp || Math.floor(Date.now() / 1000);
        if (!this.isDecayFeeEnabled(poolInfo)) {
            return {
                isActive: false,
