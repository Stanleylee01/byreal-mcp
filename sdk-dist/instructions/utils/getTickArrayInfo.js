 ...
 */
export async function getTickArrayInfo({ connection, poolInfo, exBitmapInfo, expectedCount = 7, // Default get 7 tick arrays
 }) {
    poolInfo;
    ...
    const startIndexArray = TickUtils.getInitializedTickArrayInRange(poolInfo.tickArrayBitmap, exBitmapInfo, poolInfo.tickSpacing, currentTickArrayStartIndex, expectedCount);
    // 3. Calculate PDA addresses for all tick arrays
    const tickArrayAddresses = [];
    const startIndexToAddress = {};
